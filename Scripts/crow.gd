...
# --- Variables para Cargar Objetos ---
@onready var _carry_point: Node3D = $CarryPoint # Nodo donde se colocan los objetos cargados
var _carrying_object: Node3D = null # Objeto actualmente cargado
